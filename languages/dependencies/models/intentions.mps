...
<model ref="r:93630ce3-7fac-4e3b-aa05-bfe26be0a38f(dependencies.intentions)">
  ...
  <node concept="2S6QgY" id="2_Omw6NptrB">
    <property role="TrG5h" value="addComentToDependencyNodeIntention" />
    <ref role="2ZfgGC" to="y83k:5NejMmYd6I_" resolve="DependencyNode" />
    <node concept="2S6ZIM" id="2_Omw6NptrC" role="2ZfVej">
      <node concept="3clFbS" id="2_Omw6NptrD" role="2VODD2">
        <node concept="3clFbF" id="2_Omw6NptVY" role="3cqZAp">
          <node concept="Xl_RD" id="2_Omw6NptVX" role="3clFbG">
            <property role="Xl_RC" value="Add Comment to Dependency" />
          </node>
        </node>
      </node>
    </node>
        ...
        <node concept="3clFbF" id="2_Omw6NpuLL" role="3cqZAp">
          <node concept="37vLTI" id="2_Omw6NpuYS" role="3clFbG">
            ...
            <node concept="2OqwBi" id="2_Omw6NpuMZ" role="37vLTJ">
              ...
              <node concept="3TrEf2" id="2_Omw6NpuT2" role="2OqNvi">
                <ref role="3Tt5mk" to="y83k:2_Omw6NotCd" />
              </node>
            </node>
          </node>
        </node>
